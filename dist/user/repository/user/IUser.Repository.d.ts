...
export declare abstract class IUserRepository extends IBaseRepository<User> {
    ...
    abstract updateProfilePicture(userId: string, profilePicture: string): Promise<void>;
    abstract updateUserName(userId: string, firstName: string, lastName: string): Promise<void>;
